		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div " >
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="../kategori/index.php" class="nav-link "><span class="pcoded-micon">
							<i class="feather icon-list"></i></span>
							<span class="pcoded-mtext">Kategori</span></a>
					</li>
					<li class="nav-item">
					    <a href="../wisata/index.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-map">
						</i></span><span class="pcoded-mtext">wisata</span></a>
					</li>
					<li class="nav-item">
					    <a href="../armada/index.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-list">
						</i></span><span class="pcoded-mtext">armada</span></a>
					</li>
					<li class="nav-item">
					    <a href="../kontak/index.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-phone">
						</i></span><span class="pcoded-mtext">kontak</span></a>
					</li>
					<li class="nav-item">
					    <a href="../tim/index.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-users">
						</i></span><span class="pcoded-mtext">tim kami</span></a>
					</li>
					<li class="nav-item">
					    <a href="../user/index.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-user">

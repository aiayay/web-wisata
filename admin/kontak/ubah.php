...
include '../koneksi.php';
$getid = $_GET['id_kontak'];

$search = mysqli_query($koneksi,"SELECT * FROM kontak WHERE id_kontak ='$getid'");
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="proses_ubah.php" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="id_kontak" value="<?=$item['id_kontak']?>">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="judul"
                                            placeholder="Masukan Nama Judul" value="<?php echo $item ['judul'];?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Isi</label>
                                        <input type="text" class="form-control" name="isi"
                                            placeholder="Masukan Isi" value="<?php echo $item ['isi'];?>">
                                    </div>
                                    <!-- <div class="form-group">
...
if (isset($_POST['submit'])){
    ...
    $update="UPDATE kategori SET id_kategori='$id_kategori'";
